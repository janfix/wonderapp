...
define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'wonderpci/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){
    'use strict';
    ...
    var wonderpci = {
        ...
        getResponse : function getResponse(){
            ...
            var Scontainer = $(this.dom),
                value = $(".Respscore").text(); // TO DO Response System
                console.log("FROM IMPORTED AMD")
    ...
    qtiCustomInteractionContext.register(wonderpci);
});
